package com.eylemabuzeyitoglu.artbookjava;
...
import com.eylemabuzeyitoglu.artbookjava.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<String> permissionLauncher;  // for permission
    ...
    public void save(View view){
        ...
        String artistName = binding.nameText.getText().toString();
        String year = binding.nameText.getText().toString();
